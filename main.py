...
def start_games(amount_of_games):
    for igen in range(40):
        ...
        for i in range(amount_of_games):
            ...
            #current_game = game.Game([player.Player(silver_deck,{'White', 'Blue'},"metaS",igen), player.Player(gold_deck,{'Red', 'Green'},"metaGish",1)])
            current_game = game.Game([player.Player(gold_deck,{'Red', 'Green'},"metaG",igen), player.Player(silver_deck,{'White', 'Blue'},"sparring",0)])
